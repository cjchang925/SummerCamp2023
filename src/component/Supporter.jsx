...
const Supporter = () => {
    ...
    const getElement = async () => {
        const response = await fetch('http://140.113.160.136:6789/api/get_element', {
            method: 'POST',
            headers: {
    ...
    const handleFinishAddingSupporter = async () => {
        ...
        setShowModal(false);
        await fetch('http://140.113.160.136:6789/api/add_supporter', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const handlePurchase = async (e) => {
        await fetch('http://140.113.160.136:6789/api/done', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
